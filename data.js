  ...
  categories: [
    ...
    },
    {
      ...
      fields: [
        ...
        { label: "描述1-1", value: "负责XX产品的需求分析与PRD撰写，协调设计、研发团队推动功能上线，用户活跃度提升15%" },
        { label: "描述1-2", value: "使用SQL进行数据埋点分析，搭建数据看板，产出每周产品运营报告，支撑团队决策" },
        { label: "公司2", value: "XX集团" },
        { label: "职位2", value: "AI产品实习生" },
        { label: "时间2", value: "20XX/09-20XX/03" },
        { label: "描述2-1", value: "参与智能客服Agent产品设计，主导知识库搭建与召回优化，意图识别准确率从72%提升至89%" },
        { label: "描述2-2", value: "调用飞书/钉钉API搭建项目看板，自动化数据抓取与前端渲染，替代原有手动维护模式" },
    ...
    },
    {
      ...
      fields: [
        ...
        { label: "项目1成果", value: "全量上线后日均处理约9,000单，人工处理量下降46%" },
